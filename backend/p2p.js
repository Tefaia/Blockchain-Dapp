...
const server = net.createServer(socket => {
    ...
    // Add the peer's address to the list of connected peers
    connectedPeers.push(socket.remoteAddress);
    ...
    socket.on('end', () => {
        // Remove the peer's address from the list of connected peers
        connectedPeers = connectedPeers.filter(peer => peer !== socket.remoteAddress);
